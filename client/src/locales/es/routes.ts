export default {
  ...
  stats: {
    title: 'Estadísticas',
    description: 'Frecuencia, volumen y evolución de tus entrenamientos',
  },
  profile: {
    title: 'Mi perfil',
  ...
  admin: {
    ...
    description: 'Métricas y gestión de usuarios',
  },
  adminCatalog: {
    title: 'Catálogo de ejercicios',
    description: 'Gestiona el catálogo base de ejercicios',
  },
  login: {
